...
// T29, T30, T31, ... + PVP
const unsigned N_TIER   = 3;
const unsigned MIN_TIER = 10;
// 1, 2, 3, 4
...
enum fight_style_e
{
  ...
  FIGHT_STYLE_CASTING_PATCHWERK,
  FIGHT_STYLE_HECTIC_ADD_CLEAVE,
  FIGHT_STYLE_DUNGEON_SLICE,
  FIGHT_STYLE_DUNGEON_ROUTE,
  // Maybe deprecated?
  FIGHT_STYLE_CLEAVE_ADD,
  FIGHT_STYLE_LIGHT_MOVEMENT,
  FIGHT_STYLE_HEAVY_MOVEMENT,
  // Deprecated
