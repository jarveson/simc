...
enum effect_subtype_t : unsigned {
    ...
    A_MOD_DAMAGE_DONE_FOR_MECHANIC = 276, // Only "Test Mod Damage % Mechanic" spell, possible mod damage done
    ...
    A_315 = 315,
    A_316 = 316,
    A_MOD_SPELL_POWER_PCT = 317,
    A_MOD_MASTERY_PCT = 318,
    A_MOD_MELEE_HASTE_3 = 319,
    A_320 = 320,
    A_321 = 321,
    A_322 = 322,
    A_323 = 323,
    ...
    A_MOD_INCREASED_CRIT_PCT_TAKEN = 569,
    A_MOD_RANGED_HASTE_2 = 615,
    A_MAX
};
