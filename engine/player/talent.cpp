...
player_talent_t::player_talent_t( const player_t* player, const spell_data_t* spell, unsigned rank )
  : m_player( player ), m_trait( &trait_data_t::nil()), m_spell( spell ), m_rank( rank )
{
}
