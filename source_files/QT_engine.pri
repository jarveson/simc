...
HEADERS += engine/dbc/ap_per_stat.hpp
...
HEADERS += engine/dbc/glyph_data.hpp
...
HEADERS += engine/dbc/item_reforge_data.hpp
...
HEADERS += engine/player/glyph.hpp
...
SOURCES += engine/dbc/ap_per_stat.cpp
...
SOURCES += engine/dbc/glyph_data.cpp
...
SOURCES += engine/dbc/item_reforge_data.cpp
...
SOURCES += engine/player/glyph.cpp
